...
1) Привезли на ферму новых животных: 5 коз - одна коза дает молоко 3-5 литров за один надой.
2) Снова 7 раз (неделю) производим сбор продукции и выводим результат на экран.
3) Сделать вывод статистики по животным: id животного и кол-во произведенной продукции за весь период.
